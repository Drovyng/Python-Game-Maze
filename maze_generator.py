...
class Cell:
    ...
    def draw(self, sc):
        ...
        if self.walls['top']:
            pygame.draw.line(sc, WALLCOLOR, (x, y), (x + TILE, y), self.thickness)
        if self.walls['right']:
            pygame.draw.line(sc, WALLCOLOR, (x + TILE, y), (x + TILE, y + TILE), self.thickness)
        if self.walls['bottom']:
            pygame.draw.line(sc, WALLCOLOR, (x + TILE, y + TILE), (x , y + TILE), self.thickness)
        if self.walls['left']:
            pygame.draw.line(sc, WALLCOLOR, (x, y + TILE), (x, y), self.thickness)
